...
`capuchin_crypt` supports the three most recent major versions of Gleam
(currently 1.15, 1.16, and 1.17) and is tested on Node 24, Node 26, the latest
Bun, the latest Deno, and Erlang OTP 27, 28, and 29.
